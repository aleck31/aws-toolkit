...
echo "部署完成！"
echo "已创建 Lambda 函数: $STOP_LAMBDA_NAME - 每7天自动停止 RDS 实例"
echo ""
echo "注意: 您可以通过 AWS 控制台手动启动 RDS 实例，或使用命令:"
echo "aws rds start-db-instance --db-instance-identifier my-rds-instance --region us-east-1"
